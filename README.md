...
- [ ] 0%
### Taches ################################################################################################
#### Partie utilisateur Taches
ERROR - [ ] Once connected, an user should modify his username, mail address or password. -> ERROR
Test 
#### Partie galerie -> sans partie notification !!! Taches
ERROR - [x] La galerie devra être publique -> accessible sans authentification. => avec les commentaires  
1 - [ ] Elle doit pouvoir permettre à l’utilisateur de les liker si celui-ci est authentifié.
Test
#### Partie montage -> sans partie upload img et la ratie bonus!!! Taches
...
Test
#### Issues
* [ ] send mail -> +++ is a BIG BIG PROB -> Should fix it in all parts
* [ ] Sign up => At the end of the registration process, user should confirm his account via an unique link sent at the email address fullfiled in the registration form.
...
### Plan ################################################################################################
Mardi       10/12   => Partie utilisateur + Test
                    => Send Mail Issue + Test
