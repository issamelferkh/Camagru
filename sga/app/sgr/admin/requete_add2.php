...
<?php
	if(!empty($_POST)){
		...
		$sql  = "INSERT INTO `requete` (`date_start`, `num_bd`,`num_requete`,`type`,`authority`,`send`,`receive`,`subject`,`division`,`date_send_division`,`division_request`,`mowaten_request`) 
		VALUES ('".mysql_escape_string($_POST['date_start'])."',
		 '".mysql_escape_string($_POST['num_bd'])."',
...
<?php  	include("include/header_admin.php"); ?>				
							<!-- Content -->
								<section>
									<!-- Elements -->
										<h2 id="elements">Ajouter une Requete</h2>
										<?php
...
<div class="4u 12u$(xsmall)">
	تاريخ التوصل </br>		
	<input type="date" name="date_start" id="demo-name"/>
</div>															
<div class="4u 12u$(xsmall)">
	رقم التسجيل في مكتب الضبط </br>
	<input type="text" name="num_bd" id="demo-name"/>
</div>
<div class="4u 12u$(xsmall)">
	رقم التسجيل في خلية الشكايات </br>
	<input type="text" name="num_requete" id="demo-name"/>
</div>
<div class="4u 12u$(xsmall)">
	نوع الوارد </br>
	<div class="select-wrapper">
		<select name="type" id="Date de Fin </br>demo-category">
<option type="text" class="form-control1"  value="not_select" selected>نوع الوارد</option>
...
<div class="4u 12u$(xsmall)">
	المشتكى </br>
	<input type="text" name="send" id="demo-name"/>
</div>
<div class="4u 12u$(xsmall)">
	المشتكى به </br>
	<input type="text" name="receive" id="demo-name"/>
</div>
<div class="6u 12u$(xsmall)">
	موضوع الشكاية </br>
	<input type="text" name="subject" id="demo-name"/>
</div>
<div class="3u 12u$(xsmall)">
	الجهة المختصة </br>
	<div class="select-wrapper">
		<select name="division" id="Date de Fin </br>demo-category">
<option type="text" class="form-control1"  value="not_select" selected>الجهة المختصة</option>
...
<div class="3u 12u$(xsmall)">
	...
	<input type="date" name="date_send_division" id="demo-name"/>
</div>
<div class="6u 12u$(xsmall)">
	السلطة المحلية </br>
	<div class="select-wrapper">
		<select name="authority" id="Date de Fin </br>demo-category">
<option type="text" class="form-control1"  value="not_select" selected>السلطة المحلية</option>
...
<div class="6u 12u$(xsmall)"> <!--not added yet in db-->
	رقم تاريخ الاحالة على السلطة المحلية  </br>
	<input type="text" name="date_send_division" id="demo-name"/>
</div>
...
<div class="12u 12u$(xsmall)"> <!--not added yet in db-->
	جواب السلطة المحلية </br>
	<textarea type="text" name="division_request" id="demo-name"></textarea>
</div>
<div class="12u 12u$(xsmall)"> <!--not added yet in db-->
	جواب السلطة الاقليمية </br>
	<textarea type="text" name="division_request" id="demo-name"></textarea>
</div>

<div class="12u 12u$(xsmall)">
	جواب الموجه الى المواطن </br>
